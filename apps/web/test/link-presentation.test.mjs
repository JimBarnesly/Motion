...
test("outgoing links retain stable targets and expose live, trashed, and missing states", () => {
  assert.deepEqual(buildLinkEntries({ pages, links, pageId: "source", direction: "outgoing" }), [
    { pageId: "live", blockId: "block-live", title: "Renamed <Target>", status: "live" },
    { pageId: "trashed", blockId: "block-trashed", title: "Old target", status: "trashed" },
    { pageId: "missing", blockId: "block-missing", title: "Missing page", status: "missing" }
  ]);
});
...
test("backlinks preserve source block IDs for deep navigation", () => {
  ...
  assert.deepEqual(entries, [{ pageId: "source", blockId: "block-live", title: "Source", status: "live" }]);
