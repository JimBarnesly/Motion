...
Reviewed: 2026-08-11
Current provisional V1 baseline: `5441e1c` (`feat/v1-phase-0-green-baseline`)
...
HTTP(S)/WebSocket denial are integrated at `5441e1c`.
...
| Core and Backup suites | 27/27 and 6/6 passed | Focused canonical and restore evidence |
...
as verification of `5441e1c` or of V1. The recorded historical baseline was
