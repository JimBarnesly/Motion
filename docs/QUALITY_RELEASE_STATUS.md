...
Reviewed: 2026-08-11
Current provisional V1 baseline: `a8e0c2f` (`feat/v1-phase-0-green-baseline`)
...
HTTP(S)/WebSocket denial are integrated at `a8e0c2f`.
...
as verification of `a8e0c2f` or of V1. The recorded historical baseline was
