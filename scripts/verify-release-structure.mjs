...
try {
  ...
  const result = await verifyReleaseStructure({ directory, expectedVersion: readArg("--version"), expectedCommit: readArg("--commit"), expectedRepository: readArg("--repository"), expectedSourceFingerprint: readArg("--source-fingerprint"),
    expectedRuntimeHashes: { x86_64: readArg("--runtime-x86_64-sha256"), aarch64: readArg("--runtime-aarch64-sha256") } });
